...
const c3 = new Customer({
    name : "Shreyas",
    email : "shreyasmh@yahoo.com",
    Amount : 12000
});

const c4 = new Customer({
    name : "Aum",
    email : "aumgh@hotmail.com",
    Amount : 40000
});

const c5 = new Customer({
    name : "Vivek",
    email : "vivekkr@gmail.com",
    Amount : 7000
});
...
const c7 = new Customer({
    name : "Satvik",
    email : "satvikdi@gmail.com",
    Amount : 50000
});

const c8 = new Customer({
    name : "Abhishek",
    email : "abhishekra@gmail.com",
    Amount : 15000
});

const c9 = new Customer({
    name : "Tarun",
    email : "tarunra@gmail.com",
    Amount : 500000
});

const c10 = new Customer({
    name : "Mritunjay",
    email : "mritunjaymi@gmail.com",
    Amount : 10000
});
